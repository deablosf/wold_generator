...
// Figure out if I want to generate thedivs and such with js instead of having them there.
...
const extraordinaryAbilities = [
    ...
    "Adept: The species have a natural inclination towards the comprehension and manipulation of paranormal energies and disciplines. The supraplane mentioned below is any alternative realm of reality where the arcane is prevalent such as a godly realm, the underworld or the spiritual plane.", 
...
const extraordinaryTable = {
  ...
  Arcane: "Arcane: The species has the ability to channel and cast magical energy, craft or weave spells and artifacts, interact with spirits, raise the dead into undead or even see into a supraplane or alternate plane of existence.",
  ...
  Extended_Lifespan: "Extended Lifespan: The species is gifted with a long life, possibly hundreds of years or even thousands of years before reaching the end of their natural lifespans. With good living, exercise and anti-aging medicines this might even extend this further.",
...
const populaceDrawbacks = [
    "Decreased Lifespan: The species does not live for very long compared to a human lifespan. They may live at most a handful of decades, none of them can see fifty-five. Though some may be considered ancient if they live to see thirty.", 
    "Missing Limbs: The species is missing some usable limbs, perhaps they have no arms or the arms they have are so small and underdeveloped that they are useless. Perhaps the species has no legs. Regardless of what is missing, they naturally do not develop a humanoid's complete set of fully functional limbs.", 
    "Brittle Bones: The species suffers from a fragile structure. If too much pressure is exerted on their bones, they will fracture, snap or shatter. Their normal physical output does not put them in danger of this but if they somehow surpass those normal limits they can inflict this damage on themselves. If they take a heavy blow from a person and do not have proper protection, they can suffer from this.", 
    "Impaired Endurance: The species is easily fatigued even working within their limits, they cannot be active for more than six hours at a time before needing a good rest.", 
    "Failing Valor: The species appears brave but when the moment of truth arrives, their conviction fails them and they cannot stand before what threatens them effectively. It is not impossible for them to fight but it is impossible for them to do so with any measure of skill; instead they will flail, swinging wildly or they will run from the target.", 
    "Debilitating Pain: The species suffers under a painful burden at all times. By misshapen form or perhaps a quirk of the environment. Whatever the reason, this species is always in some sort of pain unless medicated. Even healing magic will only remove the pain for a small amount of time.", 
    "Allergy: The species has a universally bad reaction to a certain stimulus. Materials, foods or energy wavelengths can all cause sickness, pain, nausea or simply lethargy and weakness in the species. They cannot use any Extraordinary abilities when in the presence of this allergen.", 
    "Environmental Sensitivity: The species has difficulty adapting to a certain environment and when exposed to it, they begin to fatigue faster and move slower.", 
    "Plodding Pace: The species lumbers and moves painfully slow, such as a walking speed of less than one thousand feet per hour.", 
    "Somnolent: The species is sleepy. When they sleep they sleep deeply, it is hard for them to rouse and they can (if left alone) sleep for around twenty hours a day. They hibernate for an entire season and even when awake, they need to be stimulated or they will start to doze off.", 
    "Light Sensitivity: The species becomes weak and blind when exposed to sunlight and strong UV light sources. They cannot use Extraordinary abilities while weakened in this way.", 
    "Enervated Form: The species does not possess great physical might. They have roughly half the strength of the average adult, struggling to lift even fifty pounds. They cannot possess the extraordinary ability 'Superior: Physical'.", 
    "Infirm: The species is sickly, carrying a chronic illness or burdened with a poor immune system that allows for illness after illness to infect them.", 
    "Stagnant Form: The species does not have the ability to heal naturally, only through a Surge or other Extraordinary ability can this species be healed. Even this method is only half as effective.", 
    "Extraordinary Ability Condition: One of the Extraordinary abilities of the species cannot be used unless certain conditions are met. This can be an item that focuses their power or perhaps the ability requires a human sacrifice, it may even be that the ability can only be used for an hour every day. Whatever the limitation, unless that condition is met, the Extraordinary ability cannot be used.", 
    "Psychic Vulnerability: The species has no defense against psychic manipulation or attacks. Their mental defenses are so lacking that social guile can easily manipulate them and superior social guile can dominate them as psychic powers dominate an average person. Psychic effects last until another extraordinary ability is used to break the hold.", 
    "Bio-Chemical Dissipation: The species's metabolism is harsh to a particular bio-chemical causing them to have to drain it from others. Be it plasma, endorphins or thyroid hormones; the species burns through it and will hunt down targets and drain them of theirs.", 
    "Elemental Susceptibility: When the species is exposed to a certain element by way of an attack or natural hazard, it is so effective against the species that it does double the damage.", 
    "Nullified Sense: The species does not have all the standard human senses. One or more of them were never physically developed but through advanced technology, it would be possible to attach a method through prosthetics or bio-modification.", 
    "Unique Nutrition: The species primary nutrition source is a unique but problematic substance. Perhaps it is a poison or painful minerals; it can be something taboo like the blood or flesh of their own people. If they do not keep up their diet, they starve but at a slower rate."
];
...
const militaryQuirks = [
  ...
  "All combat must be sanctified by a priest who serves as a referee. The church receives a fee for this service and can claim the bodies of the dead. In some cases, the church will raise the dead and conscript them into the holy army, severing the raised from their old lives entirely.",
...
const leadershipQuirks = [
  ...
  "When a member of the ruling class dies, any money in excess of what is spent on the funeral ceremony is passed down to the commoners of their society.",
  "The ruling class always dies at the age of sixty five. The age of sixty four is spent putting their affairs in order before honorably ending their lives before the end of their sixty fifth year.",
...
const superstitions = [
  ...
  "When a marriage ends each party must marry an animal to clear any curses or lingering negative energy from their ex. During the honeymoon, they must sacrifice their new beastly partner to the family of their ex-spouse. This will purify them and allow them to remarry clean of any ill-wishes.",
  ...
  "If a person goes to bed three times with an empty stomach, on the third day they will birth a famine spirit that breaks things and eats their essence. This ravenous spirit grows stronger if the being that gave them life dies of starvation.",
...
"Tic Tac Torrents are twin jetstreams that rise up, arc and cross over twin descending waterfalls that fall from a mountain that stretches as far as the eye can see.",
...
"Man's Might Mountain range: Mountains formed not by tectonic plates and earthquakes but by people.",
...
const technology = [
  ...
  "Bronze Age: In this age, nations and metalworking rise. Clay pots for storing food also serve as a source of art and passing on stories, worked soft metals like copper and bronze are made into tools and equipment. The people can settle in areas and take professions other than hunter or gatherer.", 
...
const definingIndustries = [
  ...
  "Transport: These daring folk will move goods or people from one place to another safely and efficiently. Perhaps they are the only means of travel between landmasses or the only people willing to ferry certain goods (i.e smugglers).",
